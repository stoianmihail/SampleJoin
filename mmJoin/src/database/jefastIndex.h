...
public:
    ...
    virtual void GetJoinNumber(weight_t joinNumber, std::vector<int64_t> &out, std::vector<weight_t> &weights)= 0;

    virtual void GetRandomJoin(std::vector<int64_t> &out) = 0;
    virtual void GetRandomJoinWithWeights(std::vector<int64_t> &out, std::vector<weight_t> &weights) = 0;
...
public:
    ...
    void GetJoinNumberWithWeights(weight_t joinNumber, std::vector<int64_t> &out, std::vector<weight_t> &weights);

    void GetRandomJoin(std::vector<int64_t> &out);
    void GetRandomJoinWithWeights(std::vector<int64_t> &out, std::vector<weight_t> &weights);
